...
/*Career Apply Start*/
add_action('init', 'career_post_apply');  
 
/*-- Custom Post Init Begin --*/
function career_post_apply()
{
  $labels = array(
    'name' => _x('Career Apply', 'post type general name'),
    'singular_name' => _x('Career Apply', 'post type singular name'),
    'add_new' => _x('Add New', 'Career Apply'),
    'add_new_item' => __('Add New Career Apply'),
    'edit_item' => __('Edit Career Apply'),
    'new_item' => __('New Career Apply'),
    'view_item' => __('View Career Apply'),
    'search_items' => __('Search Career Apply'),
    'not_found' =>  __('No Career Apply'),
    'not_found_in_trash' => __('No Career Apply found in Trash'),
    'parent_item_colon' => '',
    'menu_name' => 'careerapply'
 ...
 $args = array(
  ...
  // The following is the main step where we register the post.
  register_post_type('careerapply',$args);
}
/*Career Apply close*/


/*-- Custom Career Post Init End --*/
...
/*-- Custom locations Post Init End --*/
...
add_image_size( 'blog-thumbnails', 478, 246, array( 'center', 'top' ) );
...
document.addEventListener( 'wpcf7mailsent', function( event ) {
       location = '<?php echo get_permalink( get_page_by_title( 'Thank You' ) )?>';
